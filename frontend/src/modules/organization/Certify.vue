 <template>
  <div class="certify" v-bind:class="{nopdng: resized}">
          ...
          <div class="recipient">
            <table class="recip" v-if="badge.recipients.length > 0">
              ...
              >
                ...
                <td class="nimp">
                    <span @click="remove(badge._id, badge.code, recipient.username, recipient.fullname)" class="remove nmrgn">Remove</span>
                </td>
              </tr>
            </table>
    ...
    <b-modal
      ...
      hide-footer
    >
      <Addrecipient @submit="getData" :badgeinfo="{code: badge_code, id: badge_id}"></Addrecipient>
    </b-modal>
    <b-modal
      class="modl"
      size="lg"
    ...
    <b-modal
      ...
      hide-footer
    >
      <Remove :recipient="user2remove" @submit="getData"></Remove>
    </b-modal>
    <b-modal
      class="modl"
      size="sm"
